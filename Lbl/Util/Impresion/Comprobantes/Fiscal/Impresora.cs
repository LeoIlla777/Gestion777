    ...
    public class Impresora
    {
        ...
        public Lazaro.Base.Util.Impresion.Comprobantes.Fiscal.Respuesta Inicializar()
        {
            ...
            switch (Modelo)
            {
                case Lbl.Impresion.ModelosFiscales.Emulacion:
                    ...
                    break;
                case Lbl.Impresion.ModelosFiscales.EpsonTicketUSB:
                    //Se usa la clase.
                    break;
                default:
        ...
        public Lazaro.Base.Util.Impresion.Comprobantes.Fiscal.Respuesta ImprimirComprobante(int idComprob)
        {
            ...
            try
            {
                ...
                //(LEO).Imprime el remito relacionado-Hacer para que imprima en la nota
                //de credito la factura relacionada.
                ...
                string Domicilio = Comprob.Cliente != null && Comprob.Cliente.Domicilio != null ? Comprob.Cliente.Domicilio : "";
                string ClienteLocalidad = "";
                if (Comprob.Cliente != null && Comprob.Cliente.Localidad != null)
                ...
                switch (Modelo)
                {
                    ...
                    case Lbl.Impresion.ModelosFiscales.Emulacion:
                        ...
                        if (Comprob.ClienteFree != null && Comprob.ClienteFree.Nombre != null && Comprob.ClienteFree.Nombre.Trim() != "")
                        {
                            ...
                            string nameCliente = Comprob.ClienteFree.Nombre;
                            if (nameCliente.Length > 40)
                            {
                                ClienteLinea1 = nameCliente.Substring(0, 40);
                                ClienteLinea2 = nameCliente.Substring(40, nameCliente.Length - 40);
                            }
                            else
                            {
                                ClienteLinea1 = nameCliente;
                                ClienteLinea2 = "";
                            }
                        }
                        else
                        ...
                        {
                            case 1:
                                ClienteSituacionEpson = "F";//Consumidor Final.
                                break;
                            case 2:
                                ClienteSituacionEpson = "I";//Responsable Inscripto.
                                break;
                            case 3:
                                ClienteSituacionEpson = "R";//Responsable No Inscripto.
                                break;
                            case 4:
                                ClienteSituacionEpson = "M";//Monotributo
                                break;
                            case 5:
                                ClienteSituacionEpson = "E";//Exento
                                break;
                            default:
                                ClienteSituacionEpson = "S";//No categorizado
                                break;
                        }
                        if (Modelo == Lbl.Impresion.ModelosFiscales.EpsonTiquedora)
                        {
                            ...
                            if (TextoRemitoLinea1 == "")
                                TextoRemitoLinea1 = Comprob.Tipo.EsNotaCredito ? "Fact Nro " + this.NumeroPV.ToString() + "-000" : ".";
                            ...
                            ComandoAEnviar = new Comando(CodigosComandosFiscales.EpsonDocumentoFiscalAbrir,
                                     ...
                                     "C",
                                     Letra,
                                     "2",//cantidad de copias, //(LEO)-Parametrizar.
                                     "P",
                                     "10",
                                     "I",
                ...
                // *** Imprimir Detalles
                int cantReg = Comprob.Articulos.Count;
                int regActual = 0;
                foreach (Lbl.Comprobantes.DetalleArticulo Detalle in Comprob.Articulos)
                {
                    ...
                    switch (Modelo)
                    {
                        case Lbl.Impresion.ModelosFiscales.EpsonTiquedora:
                            ...
                            if (ItemNombre.Length > 18 && Detalle.Articulo != null)
                            {
                                if (Detalle.Articulo.Modelo.Length > 0)
                                {
                                    ItemNombre = Detalle.Articulo.Modelo;
                                    if (Detalle.Articulo.Marca != null)
                                        ItemNombre += " " + Detalle.Articulo.Marca.Nombre;
                                }
                            }
                ...
                switch (Modelo)
                {
                    ...
                    case Lbl.Impresion.ModelosFiscales.Emulacion:
                        ComandoAEnviar = new Comando(CodigosComandosFiscales.EpsonDocumentoFiscalPagosYDescuentos,
                                FiscalizarTexto(Comprob.FormaDePago.ToString(), Modelo == Lbl.Impresion.ModelosFiscales.EpsonTiquedora ? 10 : 50),
            ...
            {
                Lbl.Log logging = new Lbl.Log(@"c:\temp\errorfiscal.txt");
                logging.EscribirLog(exImp);
            }
            if (Res.Error != ErroresFiscales.Ok)
            {
            ...
            else
            {
                ...
                catch (Exception ex)
                {
                    ...
                    Res.Lugar = "ImprimiendoComprobante.Comando";
                    Res.Mensaje = ex.ToString();
                    if (Res.NumeroComprobante > 0)
                    {
                        try
                        {
                            Trans = Comprob.Connection.BeginTransaction(IsolationLevel.Serializable);
        ...
        public Lazaro.Base.Util.Impresion.Comprobantes.Fiscal.Respuesta Enviar(Comando comando)
        {
            ...
            do
            {
                try
                {
                    if (Modelo != Lbl.Impresion.ModelosFiscales.HasarGenerico && Modelo != Lbl.Impresion.ModelosFiscales.HasarTiquedora)
                    {
                        PuertoSerie.DtrEnable = false;//Ver si por esto no imprime la usb
        ...
        private static string FiscalizarTexto(string cadena, int longitudMax)
        {
            ...
            if (longitudMax == 10 && sRes.ToLower() == "cuenta corriente")
                sRes = "Cta.Cte.";
