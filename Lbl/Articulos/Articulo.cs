...
{
    [Lbl.Atributos.Nomenclatura(NombreSingular = "Articulo", Grupo = "Articulos")]
    ...
    public class Articulo : ElementoDeDatos, IElementoConImagen, Lbl.IEstadosEstandar
    {
        ...
        public decimal ObtenerExistencias()
        {
            switch (this.TipoDeArticulo)
            {
                ...
                case Articulos.TiposDeArticulo.ProductoSimple:
                    return this.Connection.FieldDecimal(@"SELECT SUM(cantidad) FROM articulos_stock WHERE id_articulo=" + this.Id.ToString() + " AND id_situacion IN (SELECT id_situacion FROM articulos_situaciones WHERE cuenta_stock<>0)");
        ...
        /// <summary>
        /// El precio de costo se cotiza a otra moneda.
        /// </summary>
        public int ConOtraMoneda
        {
            get
            {
                return this.GetFieldValue<int>("conotramoneda");
            }
            set
            {
                Registro["conotramoneda"] = value;
            }
        }
        ...
        public string Estante
        {
            get
            {
                return this.GetFieldValue<string>("estante");
            }
            set
            {
                Registro["estante"] = value;
            }
        }
        ...
        public string Estanteria
        {
            get
            {
                return this.GetFieldValue<string>("estanteria");
            }
            set
            {
                Registro["estanteria"] = value;
            }
        }
