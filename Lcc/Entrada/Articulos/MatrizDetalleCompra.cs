...
{
    public partial class MatrizDetalleCompra : AuxiliarMatrizDetalleCompra
    {
        ...
        public System.Collections.Generic.List<DetalleCompra> ChildControls {
            get {
                return Controles;
            }
        }
        ...
        public void CargarArticulos(IList<Lbl.Comprobantes.DetalleArticulo> articulos)
        {
            ...
            else
            {
                ...
                for (int i = 0; i < articulos.Count; i++)
                {
                    ...
                    this.ChildControls[i].ImporteNoGravado = articulos[i].ImporteNoGravado;
        ...
        new public bool Changed {
            get {
                foreach (DetalleCompra Control in this.ChildControls)
                {
                    if (Control.Changed)
                        return true;
                }
        ...
        public bool PedirSeguimiento {
            get {
                return m_PedirSeguimiento;
            }
            set {
                m_PedirSeguimiento = value;
                foreach (DetalleCompra Control in this.ChildControls)
                {
                    Control.PedirSeguimiento = m_PedirSeguimiento;
                }
            }
        }
