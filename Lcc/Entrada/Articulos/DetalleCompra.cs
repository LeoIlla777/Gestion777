...
{
    public partial class DetalleCompra : ControlSeleccionElemento
    {
        ...
        protected decimal m_ImporteUnitarioIva = 0m, m_descAnt = 0;
        protected string m_Persona = "";
        protected int m_IdArticulo = 0;
        protected bool m_Seguimiento = true;
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (Lfx.Workspace.Master != null)
            {
                ...
                {
                    case Precios.Costo:
                        EntradaUnitario.DecimalPlaces = EntradaNoGravado.DecimalPlaces = Lfx.Workspace.Master.CurrentConfig.Moneda.DecimalesCosto;
                        EntradaImporte.DecimalPlaces = EntradaNoGravado.DecimalPlaces = Lfx.Workspace.Master.CurrentConfig.Moneda.DecimalesCosto;
                        break;
                    case Precios.Pvp:
        ...
        override public bool ShowChanged {
            set {
                ...
                EntradaNoGravado.ShowChanged = value;
            }
        }
        ...
        public bool MuestraPrecio {
            ...
            set {
                ...
                EntradaNoGravado.Visible = value;
                if (value)
        ...
        new public bool Changed {
            ...
            set {
                ...
                EntradaNoGravado.Changed = value;
            }
        }
        ...
        public bool BloquearPrecio {
            ...
            set {
                ...
                EntradaNoGravado.ReadOnly = value;
        ...
        public int NoGravadoLeft {
            get {
                return EntradaNoGravado.Left;
            }
        }
        ...
        public decimal ImporteNoGravado {
            get {
                return EntradaNoGravado.ValueDecimal;
            }
            set {
                EntradaNoGravado.ValueDecimal = value;
                this.Changed = false;
            }
        }
        ...
        public decimal ImporteUnitarioFinal {
            get {
                return (this.ImporteUnitario + this.ImporteNoGravado) * this.Cantidad * (1m - this.Descuento / 100m);
            }
        }
        ...
        public decimal Descuento {
            get {
                decimal verDesc = CalcularDescuento();
                if (verDesc == 0)
                    verDesc = EntradaDescuento.ValueDecimal;
                return verDesc;
            }
            set {
        ...
        public override bool TemporaryReadOnly {
            ...
            set {
                ...
                if (value)
                {
                    ...
                    EntradaNoGravado.TemporaryReadOnly = true;
                }
                this.VerificarStock();
            }
        }
        ...
        {
            if (this.PedirSeguimiento && this.Articulo != null && this.Articulo.ObtenerSeguimiento() != Lbl.Articulos.Seguimientos.Ninguno && this.ObtenerDatosSeguimiento != null)
        ...
        private void EntradaNoGravado_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
        {
            switch (e.KeyCode)
            {
                case Keys.E:
                    if (e.Control)
                    {
                        EntradaNoGravado.SelectionLength = 0;
                        EntradaNoGravado.SelectionStart = EntradaNoGravado.Text.Length;
                        e.Handled = true;
                    }
                    break;
                case Keys.Left:
                    if (EntradaNoGravado.SelectionStart == 0)
                    {
                        e.Handled = true;
                        EntradaUnitario.Focus();
                    }
                ...
                case Keys.Right:
                case Keys.Return:
                    if (EntradaNoGravado.SelectionStart >= EntradaNoGravado.TextRaw.Length || EntradaNoGravado.SelectionLength > 0)
                    {
                        e.Handled = true;
                        EntradaCantidad.Focus();
                    }
        ...
        protected void CambiarArticulo(Lbl.Articulos.Articulo articulo)
        {
            if (this.Articulo != null)
            {
                ...
                EntradaNoGravado.Enabled = true;
                EntradaDescuento.Enabled = true;
                EntradaCantidad.Enabled = true;
                EntradaImporte.Enabled = true;
                EntradaCantidad.TemporaryReadOnly = (this.PedirSeguimiento && this.Articulo.ObtenerSeguimiento() != Lbl.Articulos.Seguimientos.Ninguno) || this.TemporaryReadOnly;
                EntradaUnitario.TemporaryReadOnly = this.TemporaryReadOnly || this.BloquearPrecio;
                EntradaNoGravado.TemporaryReadOnly = this.TemporaryReadOnly || this.BloquearPrecio;
            ...
            else if (EntradaArticulo.Text.Length == 0 || (EntradaArticulo.Text.IsNumericInt() && EntradaArticulo.ValueInt == 0))
            {
                ...
                EntradaNoGravado.Enabled = false;
        ...
        protected void EstablecerImporteUnitarioOriginal(decimal unitario)
        {
            ...
            //    decimal unitarioSinIVA = unitario / (1 + (m_Alicuota.Porcentaje / 100m));
            //    this.ImporteIvaUnitario = unitario - unitarioSinIVA;
            //    if (this.DiscriminarIva) {
            //        EntradaUnitario.ValueDecimal = unitarioSinIVA;
            //        EntradaIva.ValueDecimal = this.ImporteIvaUnitario;
            //    } else {
            //        EntradaUnitario.ValueDecimal = unitarioSinIVA + this.ImporteIvaUnitario;
        ...
        protected void RecalcularImporteFinal()
        {
            ...
            try
            {
                decimal ImporteFinal = (this.ImporteUnitario + this.ImporteNoGravado + this.ImporteIvaDiscriminadoUnitario) * this.Cantidad * (1m - this.Descuento / 100m);
