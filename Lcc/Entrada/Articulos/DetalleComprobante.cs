...
namespace Lcc.Entrada.Articulos
{
    ...
    {
        protected bool m_MostrarExistencias, m_DiscriminarIva = false, m_AplicarIva = true, m_MasTarBar = false;
        ...
        private void EntradaArticulo_Enter(object sender, EventArgs e)
        {
            m_MasTarBar = false;
        }

        private void EntradaCantidad_Enter(object sender, EventArgs e)
        {
            if (m_MasTarBar)
                SendKeys.Send("{DOWN}");
        }
        ...
        protected void EstablecerImporteUnitarioOriginal(decimal unitario)
        {
            ...
            else
            {
                ...
                if (m_Alicuota != null)
                    EntradaUnitario.ValueDecimal = unitario * (1 + (m_Alicuota.Porcentaje / 100m));
                else
                    EntradaUnitario.ValueDecimal = unitario;
