...
namespace Lcc.Entrada
{
    public partial class CodigoDetalle : ControlSeleccionElemento
    {
        ...
        private string m_ExtraDetailFields = "", m_NameExtraDetailFields = "";
        ...
        public string NameExtraDetailFields {
            get {
                return m_NameExtraDetailFields;
            }
            set {
        ...
        private void MostrarBuscador(string valorIncial)
        {
            ...
            using (Statics.BusquedaRapida = new AuxForms.BusquedaRapida())
            {
                ...
                Statics.BusquedaRapida.NameExtraDetailFields = m_NameExtraDetailFields;
        ...
        private void EntradaFreeText_KeyPress(object sender, System.Windows.Forms.KeyPressEventArgs e)
        {
            if (this.ReadOnly || this.TemporaryReadOnly)
                e.Handled = true;
        }
