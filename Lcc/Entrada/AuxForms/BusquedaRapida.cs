...
namespace Lcc.Entrada.AuxForms
{
    public partial class BusquedaRapida : Lui.Forms.Form, Lui.Forms.IDataForm, IFormularioBusqueda
    {
        ...
        private string m_NameExtraDetailFields = "";
        ...
        [System.ComponentModel.Category("Datos")]
        public string NameExtraDetailFields {
            set {
                m_NameExtraDetailFields = value;
                UpdateDetail();
            }
        }
        ...
        private void UpdateDetail()
        {
            ...
            {
                m_ExtraDetailFields = "codigo1,codigo2,codigo3,stock_actual";
                m_NameExtraDetailFields = "Código 1, Código 2, Código 3, Stock";
            }
            else if (m_Table == "personas" && (m_ExtraDetailFields == null || m_ExtraDetailFields.Length == 0))
            {
                m_ExtraDetailFields = "num_doc,cuit,extra1";
                m_NameExtraDetailFields = "Documento, CUIT, Extra";
            }
            ...
            else if (m_Table == "tipo_doc" && (m_ExtraDetailFields == null || m_ExtraDetailFields.Length == 0))
            {
                ...
                m_NameExtraDetailFields = "Descripción";
            ...
            if (m_NameExtraDetailFields != null && m_NameExtraDetailFields.Length > 0)
            {
                string[] colName = m_NameExtraDetailFields.Split(',');
                for (int icol = 0; icol < colName.Length; icol++)
                    if (icol < 4)
                        Listado.Columns[icol + 2].Text = colName[icol];
            }
