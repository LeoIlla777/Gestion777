...
namespace Lfc.Pvs
{
    public partial class Editar : Lcc.Edicion.ControlEdicion
    {
        ...
        public override void ActualizarControl()
        {
            ...
            EntradaEnumerar.ValueInt = (int)(Pv.Enumerar);
            EntradaPersona.ValueInt = Pv.Persona;
        ...
        public override void ActualizarElemento()
        {
            ...
            Pv.Enumerar = EntradaEnumerar.ValueInt;
            Pv.Persona = EntradaPersona.ValueInt;
        ...
        public void InicarServidorFiscal()
        {
            ...
            {
                Process[] ServidoresFiscales = Process.GetProcessesByName("Fiscal.exe");
                ...
                {
                    ServidoresFiscales = Process.GetProcessesByName("Fiscal");
                    foreach (Process pro in ServidoresFiscales)
                    {
                        pro.CloseMainWindow();
                        pro.WaitForExit();
                    ...
                    if (ServidoresFiscales.Length == 0)
                        Lfx.Environment.Shell.Execute(@"C:\Users\Leona\Source\Workspaces\Excelencia\Excelencia-Gestion\Sistema\bin\Debug\" + "Fiscal.exe", null, System.Diagnostics.ProcessWindowStyle.Normal, false);
                }
            }
            else
            {
