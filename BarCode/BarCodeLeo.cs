...
namespace BarCodeLeo
{
    ...
    public class BarCodeLeo : IDisposable
    {
        #region Variables
        ...
        public BarCodeLeo(string data)
        {
            //constructor
            this.Raw_Data = data;
        }//Barcode
        public BarCodeLeo(string data, TYPE iType)
        {
            this.Raw_Data = data;
